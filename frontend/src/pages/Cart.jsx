      ...
      <div className="max-w-6xl mx-auto">
            ...
            {cartData.map((cartItem) => {
              ...
              return (
                <motion.div
                  ...
                  layout
                  exit="exit"
                  className="flex flex-col sm:flex-row items-center justify-between bg-white p-6 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 border border-pink-100"
                >
                  {/* Product Info */}
        ...
        {cartData.length > 0 && (
          <motion.div
            ...
            className="bg-white p-8 rounded-3xl shadow-2xl border border-pink-100 max-w-lg ml-auto"
          >
            <CartTotal />
            <motion.button
